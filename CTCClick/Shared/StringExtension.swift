...
enum Key {
    ...
    static let messageFromFinder = "CTCCLICK_FINDER_Main"
    static let messageFromMain = "CTCCLICK_MAIN_FINDER"
    
    static let apps = "CTCCLICK_APPs"
    static let actions = "CTCCLICK_ACTIONS"
    static let fileTypes = "CTCCLICK_FILE_TYPES"
    static let permDirs = "CTCCLICK_PERMISSIVE_DIRS"
    static let commonDirs = "CTCCLICK_COMMON_DIRS"
    static let showMenuBarExtra = "showMenuBarExtra"
    static let showInDock = "SHOW_IN_DOCK"
    static let showContextMenu = "SHOW_CONTEXT_MENU"
...
extension UserDefaults {
    static var group: UserDefaults {
        UserDefaults(suiteName: "group.cn.tanson.CTCClick")!
    }
    ...
    var showContextMenu: Bool {
        defaults(for: Key.showContextMenu) ?? true
    }
